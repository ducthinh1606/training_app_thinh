    ...
    return (
        <div className="task">
            ...
            <div className="action">
                ...
                <span><button onClick={() => setShowDeleteModal(true)}><svg width="20px" height="20px" xmlns="http://www.w3.org/2000/svg"
                ...
                <ReactModal
                    ...
                    className="modal-delete-task"
                    ariaHideApp={false}
                >
                    <div className="form-delete-task">
                        <h1>Delete Task</h1>
                        <h3>Are you sure?</h3>
